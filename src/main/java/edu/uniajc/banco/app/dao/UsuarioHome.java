...
import edu.uniajc.banco.app.entity.Usuario;

/**
 * Home object for domain model class Usuario.
 * @see edu.uniajc.banco.app.dao.Usuario
...
public class UsuarioHome {
	...
	public Usuario findById(int id) {
		...
		try {
			Usuario instance = (Usuario) sessionFactory.getCurrentSession().get("edu.uniajc.banco.app.dao.Usuario", id);
			if (instance == null) {
	...
	public List findByExample(Usuario instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("edu.uniajc.banco.app.dao.Usuario")
